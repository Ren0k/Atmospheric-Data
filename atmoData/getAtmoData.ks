...
function getAtmosphericData {
    // PUBLIC getAtmosphericData :: geoposition : float : float : body -> lexicon
    parameter       curBody is ship:body.

    local bodyParameters is lexicon().
    local atmHeight is curBody:atm:height.
    ...
    function getStaticAmbientTemperature {
        // PUBLIC getStaticAmbientTemperature :: bool -> float
